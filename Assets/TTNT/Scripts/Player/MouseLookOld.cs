...
/// <summary>/// Allows for the rotation of the
/// camera to be controlled by the mouse </summary>
public class MouseLookOld : MonoBehaviour
{
    /// <summary> Enumeration for the two axes
    /// of rotational movement of the camera </summary>
    ...
    /// <summary> Header for
    /// rotation variables </summary>
    [Header("Rotation Variables")]
    // Sets axis as MouseX by default
    public RotationalAxis axis = RotationalAxis.MouseX;
    /// <summary> A range for the
    /// sensitivity of the camera rotation </summary>
    [Range(0, 500)] public float sensitivity = 300;
    /// <summary> The minimum and
    /// maximum values for y rotation </summary>
