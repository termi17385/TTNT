...
using UnityEngine.Events;
    ...
    public class CustomNetworkDiscovery : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
    {
        ...
        public override void Start()
        {
            ...
            // Transport.active Transport is set in Awake of Transport components.
            if (transport == null)
        ...
        protected override void ProcessResponse(DiscoveryResponse _response, IPEndPoint _endpoint)
        {
            ...
            // However we know the real ip address of the server because we just received a packet from it, so use that as the host uri
